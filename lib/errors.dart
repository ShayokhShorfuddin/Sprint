...
variable_not_found(variable_name, line) {
  String error =
      "Variable Not Found: No variable called '$variable_name' exists.";
...
invalid_index(given_invalid_index, line) {
  String error =
      "Invalid Index: $given_invalid_index is not a valid index. Index must be an integer.";
  print(colorize(error, line));
}
...
function_doesnt_exist(function_name, line) {
  String error = "Function Not Found: Function $function_name doesn't exist.";
  print(colorize(error, line));
}
...
invalid_variable_name(name, line) {
  String error = "Invalid Variable Name: $name is not a valid variable name.";
  print(colorize(error, line));
}

// An Unexpected "end" keyword is detected
unexpected_end_keyword(line) {
  String error = "Unexpected End: An unexpected end keyword is found.";
  print(colorize(error, line));
}
