...
## Get Started
To get started with Sprint, follow the steps below -<br>Head to https://sprint-pi.vercel.app and download the latest Sprint release.<br>After downloading, copy the path to sprint.exe and add the path into yours environmental variables.
